...
# Ensemble Models Configuration for TSLA
ENSEMBLE_CONFIG = {
    'linear_regression': {
        'display_name': 'Linear Regression',
        'model_file': 'linear_regression_TSLA_1h_model.pkl',
        'config_file': 'linear_regression_TSLA_1h_config.pkl',
        'type': 'traditional_ml',
        'weight': 0.5  # Equal weight for ensemble
    },
    'lstm': {
        'display_name': 'LSTM',
        'model_file': 'lstm_TSLA_1h_model.pt',
